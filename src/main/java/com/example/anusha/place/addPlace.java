...
public class addPlace extends ActionBarActivity implements AdapterView.OnItemClickListener {
    ...
    private static final String API_KEY = "AIzaSyAip176aPZ6BNcyDMXnNNoihG28BfTg9G4";
